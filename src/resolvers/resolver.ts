...
export const resolvers = {
  Query: {
    ...
    product: (_, args, ctx) => ctx.dataSources.orderManagementDb.getProduct(args),
    products: (_, __, ctx) => ctx.dataSources.orderManagementDb.getProducts(),
    location: (_, args, ctx) => ctx.dataSources.orderManagementDb.getLocation(args),
  ...
  Mutation: {
    ...
    createProduct: (_, args, ctx) => ctx.dataSources.orderManagementDb.createProduct(args),
    createLocation: (_, args, ctx) => ctx.dataSources.orderManagementDb.createLocation(args)
  }
};
